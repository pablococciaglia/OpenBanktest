...
export const ResponseKO = () => {
	...
	return (
		<>
			...
			<h3>
				No hemos podido modificar tu Password Manager. Inténtalo más tarde.
			</h3>
			<div className='screen3__buttonbox'>
				<span onClick={handleReturnHome} className='screen3__button'>
					Volver a Password Manager <i className='bi bi-chevron-right'></i>
				</span>
			</div>
		</>
	);
